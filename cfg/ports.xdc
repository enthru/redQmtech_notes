...
set_property IOSTANDARD LVCMOS25 [get_ports {exp_p_tri_io[1]}]
...
#moved
set_property PACKAGE_PIN L22 [get_ports {exp_n_tri_io[1]}]

#MOVED 10db att.
set_property PACKAGE_PIN J21 [get_ports {exp_p_tri_io[2]}]
set_property PACKAGE_PIN J22 [get_ports {exp_n_tri_io[2]}]
...
#MOVED ctrl4
set_property PACKAGE_PIN K19 [get_ports {exp_p_tri_io[7]}]
set_property PACKAGE_PIN K20 [get_ports {exp_n_tri_io[7]}]
...
set_property PACKAGE_PIN D20 [get_ports Vaux4_v_p]
set_property PACKAGE_PIN C20 [get_ports Vaux4_v_n]
set_property PACKAGE_PIN E21 [get_ports Vaux5_v_p]
set_property PACKAGE_PIN D21 [get_ports Vaux5_v_n]
set_property PACKAGE_PIN E19 [get_ports Vaux14_v_p]
set_property PACKAGE_PIN E20 [get_ports Vaux14_v_n]
set_property PACKAGE_PIN H22 [get_ports Vaux15_v_p]
set_property PACKAGE_PIN G22 [get_ports Vaux15_v_n]
